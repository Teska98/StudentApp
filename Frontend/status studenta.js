...
methods:{
    refreshData(){
        ...
        axios.get(variables.API_URL+"StudentStatus")
        .then((response)=>{
    ...
    editClick(emp){
        ...
        this.IndexNumber=emp.LastName,
        this.YearOfStudy=emp.YearOfStudy,
        this.StudnetStatus=emp.StudnetStatus,
        this.Course=emp.Course,
    },
    createClick(){
        axios.post(variables.API_URL+"Student",{
            ...
            StudnetStatus:this.StudnetStatus,
            Course:this.Course,
        })
        .then((response)=>{
            this.refreshData();
